...
function SettingAuto.main()
    ...
    GUI:LoadExport(parent, "set/setting_auto")
...
function SettingAuto.CreateInput2ClickCell(parent, data)
    ...
    -- 描述
    local Text_desc = GUI:Text_Create(Panel_Layout, "Text_desc", 4, 27, 16, "#ffffff", [[身边]])
    GUI:setAnchorPoint(Text_desc, 0, 0.5)
    GUI:setTouchEnabled(Text_desc, false)
    GUI:Text_enableOutline(Text_desc, "#000000", 1)

    local Text_desc_0 = GUI:Text_Create(Panel_Layout, "Text_desc_0", 70, 27, 16, "#ffffff", [[格有怪时不捡物]])
    ...
    -- 输入框背景
    local Image_2 = GUI:Image_Create(Panel_Layout, "Image_2", 55, 26, "res/private/new_setting/textBg.png")
    ...
    -- 开关容器
    local CheckBox_able = GUI:Layout_Create(Panel_Layout, "CheckBox_able", 190, 25, 44, 18, false)
    ...
    --输入框
    local TextField_input = GUI:TextInput_Create(Image_2, "TextField_input", 12, 15, 26, 26, 14)
...
function SettingAuto.CreateClickCell(parent, data)
    ...
    -- 描述
    local Text_desc = GUI:Text_Create(Panel_Click, "Text_desc", 5, 20, 16, "#ffffff", data.content or "")
    GUI:setAnchorPoint(Text_desc, 0, 0.5)

    --开关容器
    local CheckBox_able = GUI:Layout_Create(Panel_Click, "CheckBox_able", 190, 19, 44, 18, false)
    GUI:setAnchorPoint(CheckBox_able, 0, 0.5)
...
function SettingAuto.CreateClickInputListCell(parent, data)
    ...
    -- 描述
    local Text_desc = GUI:Text_Create(Panel_Layout, "Text_desc", 32, 28, 16, "#ffffff", [[寻路]])
    GUI:setAnchorPoint(Text_desc, 0, 0.49)
    GUI:setTouchEnabled(Text_desc, false)
    GUI:Text_enableOutline(Text_desc, "#000000", 1)

    local Text_desc_0 = GUI:Text_Create(Panel_Layout, "Text_desc_0", 106, 28, 16, "#ffffff", [[秒没有怪物时使用]])
    GUI:setAnchorPoint(Text_desc_0, 0, 0.49)
    GUI:setTouchEnabled(Text_desc_0, false)
    GUI:Text_enableOutline(Text_desc_0, "#000000", 1)

    -- 输入框背景
    local Image_bg = GUI:Image_Create(Panel_Layout, "Image_bg", 86, 26, "res/private/new_setting/textBg.png")
    ...
    -- 物品名称背景
    local Image_2 = GUI:Image_Create(Panel_Layout, "Image_2", 240, 26, "res/private/new_setting/textBg.png")
    ...
    -- 物品名称
    local Text_name = GUI:Text_Create(Image_2, "Text_name", 50, 15, 18, "#109c18", "")
    ...
    --输入框
    local TextField_input = GUI:TextInput_Create(Image_bg, "TextField_input", 13, 14, 29, 26, 14)
    GUI:setAnchorPoint(TextField_input, 0.5, 0.5)
    GUI:TextInput_setTextHorizontalAlignment(TextField_input, 1)
...
function SettingAuto.CreateClickInput2ListCell(parent, data)
    ...
    -- 描述
    local Text_desc = GUI:Text_Create(Panel_Layout, "Text_desc", 32, 28, 16, "#ffffff", [[周围]])
    GUI:setAnchorPoint(Text_desc, 0, 0.49)
    GUI:setTouchEnabled(Text_desc, false)
    GUI:Text_enableOutline(Text_desc, "#000000", 1)

    local Text_desc_0 = GUI:Text_Create(Panel_Layout, "Text_desc_0", 106, 28, 16, "#ffffff", [[格有]])
    GUI:setAnchorPoint(Text_desc_0, 0, 0.49)
    GUI:setTouchEnabled(Text_desc_0, false)
    GUI:Text_enableOutline(Text_desc_0, "#000000", 1)
    ...
    local Text_desc_0_0 = GUI:Text_Create(Panel_Layout, "Text_desc_0_0", 179, 28, 16, "#ffffff", desc)
    ...
    -- 输入框背景2
    local Image_bg2 = GUI:Image_Create(Panel_Layout, "Image_bg2", 159, 26, "res/private/new_setting/textBg.png")
    ...
    -- 物品名称背景
    local Image_2 = GUI:Image_Create(Panel_Layout, "Image_2", 264, 26, "res/private/new_setting/textBg.png")
    GUI:Image_setScale9Slice(Image_2, 33, 33, 9, 9)
    GUI:setContentSize(Image_2, 95, 28)
    GUI:setIgnoreContentAdaptWithSize(Image_2, false)
    GUI:setAnchorPoint(Image_2, 0, 0.5)
    GUI:setTouchEnabled(Image_2, true)

    -- 物品名称
    local Text_name = GUI:Text_Create(Image_2, "Text_name", 47.5, 15, 18, "#109c18", "")
    GUI:setAnchorPoint(Text_name, 0.5, 0.5)
    GUI:setTouchEnabled(Text_name, false)
    GUI:Text_enableOutline(Text_name, "#111111", 1)
    ...
    --输入框1
    local TextField_input = GUI:TextInput_Create(Image_bg, "TextField_input", 15, 14, 26, 26, 14)
    GUI:setAnchorPoint(TextField_input, 0.5, 0.5)
    GUI:TextInput_setTextHorizontalAlignment(TextField_input, 1)
    GUI:TextInput_setMaxLength(TextField_input, 2)
    GUI:TextInput_setInputMode(TextField_input, 2)
    ...
    --输入框2
    local TextField_input2 = GUI:TextInput_Create(Image_bg2, "TextField_input2", 15, 14, 26, 26, 14)
...
function SettingAuto.CreateClickInpuCell(parent, data)
    ...
    local Text_desc_0 = GUI:Text_Create(Panel_Layout, "Text_desc_0", 106, 28, 16, "#ffffff", [[格有敌人时主动攻击]])
    GUI:setAnchorPoint(Text_desc_0, 0, 0.49)
    GUI:setTouchEnabled(Text_desc_0, false)
    GUI:Text_enableOutline(Text_desc_0, "#000000", 1)
...
function SettingAuto.CreateListPanel(parent, data)
    ...
    -- 标题
    local Image_title = GUI:Image_Create(Panel_Layout, "Image_title", 100.91, 198.82, "res/private/new_setting/textBg.png")
    ...
    -- 背景
    local Image_2 = GUI:Image_Create(Panel_Layout, "Image_2", 100.91, 182.81, "res/private/new_setting/textBg.png")
    GUI:Image_setScale9Slice(Image_2, 33, 33, 9, 9)
    ...
    -- 新增
    local Button_add = GUI:Button_Create(Panel_Layout, "Button_add", 49.41, 20.66, "res/private/new_setting/btnbg.png")
    ...
    -- 删除
    local Button_del = GUI:Button_Create(Panel_Layout, "Button_del", 151.21, 20.66, "res/private/new_setting/btnbg.png")
...
function SettingAuto.CreateSelect2Cell(parent, data)
    ...
    -- 描述
    local Text_desc = GUI:Text_Create(Panel_Layout, "Text_desc", 10, 27, 16, "#ffffff", data.content or "")
    GUI:setAnchorPoint(Text_desc, 0, 0.5)
    GUI:setTouchEnabled(Text_desc, false)
    GUI:Text_enableOutline(Text_desc, "#000000", 1)

    -- 点击的背景
    local Image_Click = GUI:Image_Create(Panel_Layout, "Image_Click", 120, 13, "res/private/new_setting/textBg.png")
    ...
    -- 描述
    local Text_desc2 = GUI:Text_Create(Image_Click, "Text_desc2", 52, 14, 18, "#109c18", "")
