...
function MainProperty.main()
    ...
    GUI:setPositionX(MainProperty._ui.bottomImg, screenW / 2 - 100)
...
function MainProperty.GetChatWidth()
    local chatWid = MainProperty._ui and GUI:getContentSize(MainProperty._ui.ListView_minichat).width
    return chatWid
end
