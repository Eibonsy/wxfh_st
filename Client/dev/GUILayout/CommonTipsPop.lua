...
function CommonTipsPop.InitDesc()
	...
	local daxiao = SL:GetMetaValue("WINPLAYMODE") and 16 or 18

    local richText = GUI:RichText_Create(CommonTipsPop._ui.DescList, "desc_text", 0, 0, CommonTipsPop._data.str, limitWid, daxiao, "#FFFFFF", nil, nil, commonTipsFontPath)
    if richText then
