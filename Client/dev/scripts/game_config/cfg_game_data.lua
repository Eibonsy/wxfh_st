local config = { 
	["avoid_injury"] = { 
		k = "avoid_injury",
		value = "30#5#4#0#20#3#20#15#0#20#16#16#15#15#20",
	...
	["announce"] = { 
		k = "announce",
		value = "为防止玩家上当受骗行会公告需掌门人达到55级才允许编辑有问题需要解答联系官方微信客服找队友并肩作战可以进入官方歪歪80890歪歪下载地址www.yy.com",
		notice = "默认公告",
	},
	["warehouse_max_num"] = { 
		k = "warehouse_max_num",
	...
	["declareWar"] = { 
		k = "declareWar",
		value = "2#7#100000&4#7#200000&8#7#300000&12#7#500000",
	...
	["alliance"] = { 
		k = "alliance",
		value = "1#7#20000&2#7#30000&6#7#50000&12#7#80000&24#7#100000",
	...
	["noDigMonsters"] = { 
		k = "noDigMonsters",
		value = "21#40#41#42#43#49#65#68#69#72",
	...
	["AbilInfoEx"] = { 
		k = "AbilInfoEx",
		value = "PK值#&<TMONEY/PK点>&|声望点#&<TMONEY/声望点>&|兽魂值#&<TMONEY/兽魂值>&",
	...
	["SortConfig"] = { 
		k = "SortConfig",
		value = "1#3#2|2#0#2|3#1#2|4#2#2",
		notice = "按等级排行",
	},
	["UseNewHitDmgType"] = { 
		k = "UseNewHitDmgType",
		value = 1,
		notice = "是否开启ATT表支持战士隔位技能伤害（0为关闭，1为开启，默认为0）",
	},
	["dark"] = { 
		k = "dark",
		value = 1,
	...
	["Texture2DAntialiasEnabled"] = { 
		k = "Texture2DAntialiasEnabled",
		value = 0,
		notice = "抗锯齿",
	},
	["NoShowItemDropEff"] = { 
		k = "NoShowItemDropEff",
		value = 0,
		notice = "是否物品掉落弹起效果（0为开启，1为关闭，默认为0）",
	},
}
return config
