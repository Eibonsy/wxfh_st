...
---@param userID string 目标Id
---@return userdata?
function getvisibleactor(actor,userID) end
...
---@param flag integer
---@return any
function releasemagic_target(actor, skillid, type, level, target, flag) end
...
---@return any
function takeitem(actor,itemname,qty,IgnoreJP) end
